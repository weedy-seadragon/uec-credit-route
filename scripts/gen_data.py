...
HSS = [
    ...
    ("HSS311z","法学Ａ",2),("HSS411z","法学Ｂ",2,"e"),("HSS312z","政治学Ａ",2,"e","夏期集中講義"),("HSS412z","政治学Ｂ",2,"e"),
    ...
    # HSS321z「論理学」：学修要覧2025の付録C別表1（人文・社会科学科目、HSS301z〜320z）には
    # 掲載が無いが、2026年度シラバス（timetableCode 21011220, 秋吉亮太先生, 水1, 前学期）に
    # 実在することを開発者に指摘され確認した（2026-09-07）。2025年度版の印刷後に新設された
    # 科目とみられる。夜間主可否（#印）は原本に記載が無いため、同じ「A/B分割の無い単発科目」
    # （技術史・言語学・憲法・外国文学・アジアの文化）が全て#付きであるパターンから類推して
...
# 半角にしている（2026-09-06、開発者指摘で発覚：全角だとシラバスのofferings取得が一件も
# マッチせず、時限が一切表示されない不具合になっていた。他の科目区分（哲学Ａ・生涯スポーツ演習Ａ
# 等の全角）は実際に全角でマッチ済みなので、この4科目だけの表記の問題と判断）
INTRO = [("PHY101z","基礎科学実験A1",1),("PHY201z","基礎科学実験A2",1),("CHM101z","基礎科学実験B1",1),("CHM202z","基礎科学実験B2",1),("COM101z","コンピュータリテラシー",2)]
...
# ENG302z（英語演習）は、他の外国語（独語演習/独語運用演習のように3年次/4年次で別コードに
# 分かれる）と違い、1つのコードのまま前学期・後学期どちらでも開講される（シラバス取得で
# 確認済み、2026-09-06）。add()はコード末尾の数字（3）から前学期と自動推定するが、この科目
# だけは学期を限定しない（termType=None）よう上書きする
SUBJECTS["ENG302z"]["termType"] = None
...
# 社会シミュレーション（INS502e）は学修要覧に備考が無いが、シラバス上は「前学期集中」（8月上旬の3日間）の
# 集中講義。noteが無いと曜日時限欄が「オンデマンド」と誤表示されるため夏期集中講義と明記する（2026-09-24）。
MJ_SEL_e = [("INS501e","デザイン思考概論",2),("INS601e","システム思考概論",2),("MSS402e","社会情報論",2,"e"),
            ...
            ("INS502e","社会シミュレーション",2,"","夏期集中講義"),("INS503e","コミュニケーション論",2,"e"),("INS504e","多変量解析",2,"e"),
...
II_III_EVENING_ROWS = [
    ('BCH501r', '化学生命工学実験第一', 3, 3, 5, '前学期', '', None, ['major-req']),
    ('BCH502r', '化学生命工学演習第一', 1, 3, 5, '前学期', '', None, ['major-req']),
    ('BCH601r', '化学生命工学実験第二', 3, 3, 6, '後学期', '', None, ['major-req']),
    ...
    ('BIO401k', '分子生物学', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('BIO401m', '分子生物学', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('BIO401n', '分子生物学', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('BIO401p', '分子生物学', 2, 2, 4, '後学期', '', None, ['cluster-basic-sel']),
    ('BIO401r', '分子生物学', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('BIO501i', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO501j', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO501k', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO501m', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO501n', '生体計測工学', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('BIO501p', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO501r', '生物化学', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('BIO502n', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO502r', '細胞生物工学', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('BIO503r', '生体計測工学', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('BIO504r', '生物学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('BIO601r', '神経科学', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('BIO602r', 'システム生物学', 2, 3, 6, '後学期', '', None, ['major-elecreq']),
    ('BIO603r', '生体システム工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ...
    ('CHM401m', '基礎物理化学', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('CHM401n', '基礎物理化学', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('CHM401p', '基礎物理化学', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('CHM401r', '基礎物理化学', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('CHM402m', '無機化学', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('CHM402n', '無機化学', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('CHM402p', '無機化学', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('CHM402r', '無機化学', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('CHM501r', '物理化学第一', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('CHM502r', '有機化学第一', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('CHM503r', '機器分析学', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ...
    ('CHM701m', '環境工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('CHM701r', '環境工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ...
    ('COM301f', '数値解析およびプログラミング演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('COM301g', '数値解析およびプログラミング演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('COM301h', '数値解析およびプログラミング演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('COM301i', '数値解析およびプログラミング演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301j', '数値解析およびプログラミング演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301k', '数値解析', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301m', '数値解析', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301n', '数値解析', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301p', '数値解析', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301r', '数値解析', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('COM301t', 'プログラミング通論および演習', 2, 2, 3, '前学期', 'e', None, ['prof-basic-req']),
    ('COM302t', '論理回路学', 2, 2, 3, '前学期', 'e', None, ['prof-basic-req']),
    ('COM401f', 'アルゴリズムとデータ構造およびプログラミング演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('COM401g', 'アルゴリズムとデータ構造およびプログラミング演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('COM401h', 'アルゴリズムとデータ構造およびプログラミング演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('COM401i', 'アルゴリズムとデータ構造およびプログラミング演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-free']),
    ('COM401j', 'アルゴリズムとデータ構造およびプログラミング演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-free']),
    ('COM401k', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('COM401m', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('COM401n', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('COM401p', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('COM401r', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ...
    ('COM402k', '計算機工学', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('COM402m', '計算機工学', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('COM402n', '計算機工学', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('COM402p', '計算機工学', 2, 2, 4, '後学期', '', None, ['cluster-basic-sel']),
    ('COM402r', '計算機工学', 2, 2, 4, '後学期', '', None, ['cluster-basic-sel']),
    ('COM403i', '計算機工学', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('COM403j', '計算機工学', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('COM404i', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('COM404j', 'プログラミング演習', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('COM405i', '論理回路学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM405j', '論理回路学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM501f', 'プログラミング言語実験', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('COM501g', 'コンピュータネットワーク', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('COM501h', 'コンピュータネットワーク', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('COM501m', '上級コンピュータ演習', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('COM501n', '上級コンピュータ演習', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('COM501p', '上級コンピュータ演習', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('COM501r', '上級コンピュータ演習', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('COM501t', 'プログラミング実験', 1, 3, 5, '前学期', 'e', None, ['prof-basic-req']),
    ('COM502f', 'アルゴリズム論', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('COM502t', '情報通信と符号化', 2, 3, 5, '前学期', 'e', None, ['prof-basic-elec']),
    ('COM503f', 'メディアネットワーク', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('COM504f', 'オペレーティングシステム', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('COM505f', 'コンピュータネットワーク', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('COM506f', 'データベース論', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ...
    ('COM601f', 'セキュリティ情報学実験', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('COM601t', '計算機工学', 2, 3, 6, '後学期', 'e', None, ['major-req']),
    ('COM602f', 'ユビキタスネットワーク', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM602t', '信号処理論', 2, 3, 6, '後学期', 'e', None, ['major-req']),
    ('COM603f', '暗号理論', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM603t', '情報学実験', 1, 3, 6, '後学期', 'e', None, ['major-req']),
    ('COM604f', 'ハードウェアセキュリティ', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM605f', 'ソフトウェアセキュリティ', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM606f', 'コンテンツセキュリティ', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM607f', 'ネットワークセキュリティ', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('COM701t', '通信・ネットワーク', 2, 4, 7, '前学期', 'e', None, ['major-sel']),
    ...
    ('ELE301f', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301g', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301h', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301i', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301j', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301k', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301m', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301n', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301p', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE301r', '基礎電気回路', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('ELE401g', '回路システム学第一', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE401h', '論理回路学', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE401k', '基礎電子回路', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('ELE401m', '基礎電子回路', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('ELE401n', '基礎電子回路', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('ELE401p', '基礎電子回路', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('ELE401r', '基礎電子回路', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('ELE401t', '電気回路学および演習', 3, 2, 4, '後学期', 'e', None, ['prof-basic-req']),
    ('ELE402g', '基礎情報通信', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('ELE402h', '回路システム学第一', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE402m', '理工学基礎実験', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE402n', '理工学基礎実験', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE402p', '理工学基礎実験', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE402r', '理工学基礎実験', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('ELE402t', '基礎電子工学', 2, 2, 4, '後学期', 'e', None, ['prof-basic-req']),
    ('ELE403g', '論理回路学', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    # 学修要覧2025では「情報通信と符号化」だが、2026年度シラバスではELE402g
    # （基礎情報通信）と合同開講のため、実態に合わせて名称を「基礎情報通信」に変更
    # （2026-09-07、開発者確認済み）
    ('ELE403h', '基礎情報通信', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('ELE404g', '基礎電子工学', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('ELE404h', '基礎電子工学', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('ELE501f', '情報通信システム', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('ELE501g', '回路システム学第二', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('ELE501h', '回路システム学第二', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('ELE501m', '電子工学実験第一', 3, 3, 5, '前学期', '', None, ['major-req']),
    ('ELE501n', '電磁波工学', 2, 3, 5, '前学期', '', None, ['major-req']),
    ...
    ('ELE601f', 'デジタル信号処理', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ...
    ('ELE601m', '電子工学実験第二', 3, 3, 6, '後学期', '', None, ['major-req']),
    ('ELE601n', '画像工学', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('ELE601p', '電子回路学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('ELE601r', '画像工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ...
    ('ELE701m', '電磁波工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('ELE701t', '計測工学', 2, 4, 7, '前学期', 'e', None, ['major-sel']),
    ('ELE702g', '画像処理工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('ELE702h', '音響工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('ELE703h', '画像処理工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('ELE801g', '通信法規', 2, 4, 8, '後学期', '', None, ['major-sel']),
    ('ELE801h', '通信法規', 2, 4, 8, '後学期', '', None, ['major-sel']),
    ...
    ('GEO201i', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ('GEO201j', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ('GEO201k', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ('GEO201m', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ('GEO201n', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ('GEO201p', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ('GEO201r', '地学', 2, 1, 2, '後学期', '', None, ['major-free']),
    ...
    ('GEO501n', '地学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('GEO501p', '地学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('GEO501r', '地学実験', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('GSC301s', '環境科学', 2, 2, 3, '前学期', 'e', None, ['sci-liberal']),
    ('GSE301f', '基礎演習A', 1, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('GSE301g', '基礎演習A', 1, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('GSE301h', '基礎演習A', 1, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('GSE301i', '基礎演習A', 1, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('GSE301j', '基礎演習A', 1, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('GSE301k', '計測工学概論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('GSE301m', '計測工学概論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('GSE301n', '計測工学概論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('GSE301p', '計測工学概論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('GSE301r', '計測工学概論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('GSE401g', '基礎演習B', 1, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('GSE401h', '基礎演習B', 1, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('GSE401i', '機械計測工学', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('GSE401j', '機械計測工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('GSE501i', '電気電子計測', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('GSE501j', '電気電子計測', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('GSE501k', '電気電子計測', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('GSE601g', '計測工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('GSE601h', '計測工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('GSE601i', 'デジタル信号処理', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('GSE601j', 'デジタル信号処理', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('GSE601k', 'デジタル信号処理', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('GSE701t', '先端トピックス', 2, 4, 7, '前学期', 'e', None, ['major-sel']),
    ...
    ('INS701t', '情報メディアシステム', 2, 4, 7, '前学期', 'e', None, ['major-sel']),
    ...
    ('INT401m', 'Experimental Electronics Laboratory', 2, 2, 4, '後学期', '', None, ['major-intl']),
    ('INT401n', 'Experimental Electronics Laboratory', 2, 2, 4, '後学期', '', None, ['major-intl']),
    ('INT401p', 'Experimental Electronics Laboratory', 2, 2, 4, '後学期', '', None, ['major-intl']),
    ('INT401r', 'Experimental Electronics Laboratory', 2, 2, 4, '後学期', '', None, ['major-intl']),
    ('LAB501f', 'GLTPラボワーク', 1, 4, 7, '前学期', '', None, ['major-free']),
    ('LAB501g', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501h', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501i', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501j', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501k', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501m', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501n', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501p', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ('LAB501r', 'GLTPラボワーク', 1, 3, 5, '前学期', '', None, ['major-free']),
    ...
    ('MCE401i', '機械力学および演習', 3, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE401j', '機械力学および演習', 3, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE401k', '材料力学および演習', 3, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE402i', '材料力学および演習', 3, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE402j', '材料力学および演習', 3, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE402k', 'メカノデザイン', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('MCE403i', 'メカノデザイン', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE403j', 'メカノデザイン', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE403k', '機械力学および演習', 3, 2, 4, '後学期', '', None, ['major-req']),
    ('MCE501i', '基礎制御工学および演習', 3, 3, 5, '前学期', '', None, ['major-req']),
    ('MCE501j', 'ロボットの機構と力学', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('MCE501k', '知能機械工学基礎実験第一', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('MCE501t', '制御工学', 2, 3, 5, '前学期', 'e', None, ['prof-basic-elec']),
    ('MCE502i', 'メカトロニクス基礎実験A', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('MCE502j', '人間機械システム', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('MCE502k', 'マシンデザインA', 2, 3, 5, '前学期', '', None, ['major-req']),
    ...
    ('MCE504i', '加工学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE504j', 'マシンデザインA', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('MCE504k', '熱力学応用', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('MCE505i', '熱力学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE505j', '基礎制御工学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE505k', '機構要素設計', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE506i', 'ロボットの機構と力学', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE506j', '加工学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE506k', '加工学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE507i', '人間機械システム', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE507j', '熱力学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE507k', '基礎制御工学および演習', 3, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('MCE508i', '設計基礎工学', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE508j', '設計基礎工学', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE508k', 'ロボットの機構と力学', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE509i', '機構要素設計', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE509j', '機構要素設計', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE509k', '人間機械システム', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MCE601i', 'メカトロニクス基礎実験B', 2, 4, 7, '前学期', '', None, ['major-req']),
    ('MCE601j', 'メカトロニクス基礎実験B', 2, 4, 7, '前学期', '', None, ['major-req']),
    ('MCE601k', '知能機械工学基礎実験第二', 2, 3, 6, '後学期', '', None, ['major-req']),
    ...
    ('MCE603i', '現代制御工学', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('MCE603j', '知能ロボット工学', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('MCE603k', '流体力学および演習', 3, 3, 6, '後学期', '', None, ['major-req']),
    ('MCE604i', '流体力学および演習', 3, 3, 6, '後学期', '', None, ['major-elecreq']),
    ('MCE604j', '流体力学および演習', 3, 3, 6, '後学期', '', None, ['major-elecreq']),
    ...
    ('MCE605k', '材料工学', 2, 3, 6, '後学期', '', None, ['major-elecreq']),
    ('MCE606i', 'メカトロニクス', 2, 3, 6, '後学期', '', None, ['major-elecreq']),
    ('MCE606j', 'メカトロニクス', 2, 3, 6, '後学期', '', None, ['major-elecreq']),
    ('MCE606k', 'メカトロニクス', 2, 3, 6, '後学期', '', None, ['major-elecreq']),
    ('MCE607i', '知能ロボット工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE607j', '現代制御工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE607k', '知能ロボット工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE608i', '生産システム工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE608j', '生産システム工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE608k', '現代制御工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE609i', '生体システム工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE609j', '生体システム工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('MCE609k', '生体システム工学', 2, 4, 8, '後学期', '', None, ['major-sel']),
    ('MCE701i', '自動車工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('MCE701j', '自動車工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('MCE701k', '自動車工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('MCE701t', 'メカトロニクス', 2, 4, 7, '前学期', 'e', None, ['major-sel']),
    ('MCE702i', '航空宇宙工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('MCE702j', '航空宇宙工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ('MCE702k', '航空宇宙工学', 2, 4, 7, '前学期', '', None, ['major-sel']),
    ...
    ('MTH301f', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301g', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301h', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301i', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301j', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301k', '工学基礎数学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301m', '工学基礎数学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301n', '工学基礎数学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301p', '工学基礎数学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301r', '工学基礎数学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH301t', '基礎解析学', 2, 2, 3, '前学期', 'e', None, ['math-basic-elec']),
    ('MTH302f', '応用数学A', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH302g', '応用数学A', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH302h', '応用数学A', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('MTH302i', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302j', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302k', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302m', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302n', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302p', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302r', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH302t', '応用数学第一', 2, 2, 3, '前学期', 'e', None, ['prof-basic-req']),
    ('MTH303f', '離散数学', 2, 2, 3, '前学期', '', None, ['cluster-basic-sel']),
    ('MTH303g', '離散数学', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303h', '離散数学', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303i', '応用数学A', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303j', '応用数学A', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303k', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303m', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303n', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303p', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH303r', '確率統計', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH304f', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-sel']),
    ('MTH304g', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH304h', '複素関数論', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH304i', '離散数学', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH304j', '離散数学', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('MTH401f', '応用数学B', 2, 2, 4, '後学期', '', None, ['cluster-basic-sel']),
    ('MTH401g', '応用数学B', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('MTH401h', '応用数学B', 2, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('MTH401i', '応用数学B', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('MTH401j', '応用数学B', 2, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('MTH401s', '応用幾何学', 2, 3, 5, '前学期', 'e', None, ['advanced']),
    ('MTH402f', '数理統計', 2, 2, 4, '後学期', '', None, ['major-sel']),
    ('MTH402g', '数理統計', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('MTH402h', '数理統計', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('MTH402i', '基礎演習B', 1, 2, 4, '後学期', '', None, ['cluster-basic-free']),
    ('MTH402j', '基礎演習B', 1, 2, 4, '後学期', '', None, ['cluster-basic-free']),
    ...
    ('MTH501f', '離散数学応用', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MTH501g', '幾何学概論', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MTH501h', '幾何学概論', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('MTH501i', '幾何学概論', 2, 3, 5, '前学期', '', None, ['major-free']),
    ('MTH501j', '幾何学概論', 2, 3, 5, '前学期', '', None, ['major-free']),
    ...
    ('PHO501n', '光工学実験第一', 3, 3, 5, '前学期', '', None, ['major-req']),
    ...
    ('PHY204f', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY204g', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY204h', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY204i', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY204j', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY204k', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY204m', '力学', 2, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ...
    ('PHY205r', '力学演習', 1, 1, 2, '後学期', '', None, ['cluster-basic-req']),
    ('PHY301f', '基礎電磁気学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301g', '基礎電磁気学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301h', '基礎電磁気学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301i', '基礎電磁気学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301j', '基礎電磁気学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301k', '熱力学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301m', '熱力学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301n', '熱力学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301p', '熱力学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301r', '熱力学', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY301t', '基礎物理学第三', 2, 2, 3, '前学期', 'e', None, ['math-basic-elec']),
    ('PHY302f', '波動と光', 2, 2, 3, '前学期', '', None, ['cluster-basic-sel']),
    ('PHY302g', '波動と光', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('PHY302h', '波動と光', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('PHY302i', '力学演習', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302j', '力学演習', 2, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302k', '基礎電磁気学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302m', '基礎電磁気学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302n', '基礎電磁気学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302p', '基礎電磁気学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302r', '基礎電磁気学および演習', 3, 2, 3, '前学期', '', None, ['cluster-basic-req']),
    ('PHY302t', '電磁気学および演習', 3, 2, 3, '前学期', 'e', None, ['prof-basic-req']),
    ('PHY303f', '力学演習', 2, 2, 3, '前学期', '', None, ['cluster-basic-sel']),
    ('PHY303g', '力学演習', 2, 2, 3, '前学期', '', None, ['cluster-basic-free']),
    ('PHY303h', '力学演習', 2, 2, 3, '前学期', '', None, ['cluster-basic-free']),
    ('PHY303i', '波動と光', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('PHY303j', '波動と光', 2, 2, 3, '前学期', '', None, ['cluster-basic-elecreq']),
    ('PHY401g', '電磁気学第一', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('PHY401h', '電磁気学第一', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('PHY401k', '電磁気学および演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('PHY401m', '電磁気学および演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('PHY401n', '電磁気学および演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('PHY401p', '電磁気学および演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-req']),
    ('PHY401r', '電磁気学および演習', 3, 2, 4, '後学期', '', None, ['cluster-basic-elecreq']),
    ('PHY402m', '波動と光', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('PHY402n', '波動と光', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('PHY402p', '波動と光', 2, 2, 4, '後学期', '', None, ['major-req']),
    ('PHY402r', '波動と光', 2, 2, 4, '後学期', '', None, ['major-elecreq']),
    ('PHY501g', '電磁気学第二', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('PHY501h', '電磁気学第二', 2, 3, 5, '前学期', '', None, ['major-elecreq']),
    ('PHY501m', '固体電子論', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('PHY501n', '固体電子論', 2, 3, 5, '前学期', '', None, ['major-req']),
    ('PHY501p', '物理工学実験第一', 3, 3, 5, '前学期', '', None, ['major-req']),
    ...
    ('PHY502n', '基礎量子工学', 2, 3, 5, '前学期', '', None, ['major-req']),
    ...
    ('PHY507p', '固体電子論', 2, 3, 5, '前学期', '', None, ['major-sel']),
    ('PHY601m', '半導体工学', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('PHY601n', '光電子材料学', 2, 3, 6, '後学期', '', None, ['major-req']),
    ('PHY601p', '物理工学実験第二', 3, 3, 6, '後学期', '', None, ['major-req']),
    ...
    ('PHY607p', '半導体工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('PHY608p', '計算数理工学', 2, 3, 6, '後学期', '', None, ['major-sel']),
    ('PHY609p', '電子デバイス', 2, 3, 6, '後学期', '', None, ['major-sel']),
...
SECURITY_REVIEWS = [{'id': 'y2-end', 'name': '2年次終了時審査', 'when': '2年次終了時', 'source': '2.4.1, 別表3, 別表3の2', 'anyOf': [{'allOf': [{'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjects', 'codes': ['PHY204f', 'MTH301f'], 'note': '別表3: 類共通基礎科目のうち力学・確率統計（1・2年次開講の必修科目、計4単位）'}]}, {'type': 'totalCredits', 'min': 60, 'note': '特例。ただし卒業研究着手までには前項の科目の単位を必ず修得しなければならない'}], 'onFail': {'blockedSubjects': ['COM501f', 'COM601f'], 'note': '不合格時はCOM501f・COM601fを履修できない'}}, {'id': 'thesis-start', 'name': '卒業研究着手審査', 'when': '3年次終了時', 'source': '2.4.3, 別表4', 'allOf': [{'type': 'review', 'id': 'y2-end'}, {'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'allOf': [{'type': 'allPassed', 'groupId': 'cluster-basic-req'}, {'type': 'groupMin', 'groupId': 'cluster-basic-sel', 'min': 2}]}, {'type': 'subjects', 'codes': ['COM501f', 'COM601f'], 'note': '別表4: 類専門科目の指定科目'}, {'type': 'totalCredits', 'min': 104}]}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 8}, {'type': 'totalCredits', 'min': 133}]}]
SECURITY = {
...
NETINFO_REVIEWS = [{'id': 'y2-end', 'name': '2年次終了時審査', 'when': '2年次終了時', 'source': '2.4.1, 別表3, 別表3の2', 'anyOf': [{'allOf': [{'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjects', 'codes': ['PHY204g', 'MTH301g'], 'note': '別表3: 類共通基礎科目のうち力学・確率統計（1・2年次開講の必修科目、計4単位）'}]}, {'type': 'totalCredits', 'min': 60, 'note': '特例。ただし卒業研究着手までには前項の科目の単位を必ず修得しなければならない'}], 'onFail': {'blockedSubjects': ['ELE502g', 'ELE601g', 'ELE602g'], 'note': '不合格時はELE502g・ELE601g・ELE602gを履修できない'}}, {'id': 'thesis-start', 'name': '卒業研究着手審査', 'when': '3年次終了時', 'source': '2.4.3, 別表4', 'allOf': [{'type': 'review', 'id': 'y2-end'}, {'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'allOf': [{'type': 'subjectsCountMin', 'codes': ['MTH301g', 'PHY204g', 'MTH302g', 'MTH401g', 'ELE301g', 'PHY301g', 'GSE301g', 'GSE401g', 'COM301g', 'COM401g'], 'min': 9}, {'type': 'subjectsCreditMin', 'codes': ['MTH301g', 'PHY204g', 'MTH302g', 'MTH401g', 'ELE301g', 'PHY301g', 'GSE301g', 'GSE401g', 'COM301g', 'COM401g', 'MTH303g', 'MTH304g', 'PHY302g'], 'min': 21}]}, {'type': 'subjects', 'codes': ['ELE502g', 'ELE601g', 'ELE602g'], 'note': '別表4: 類専門科目の指定科目'}, {'type': 'totalCredits', 'min': 104}]}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 1}, {'type': 'totalCredits', 'min': 133}]}]
NETINFO = {
    'schemaVersion': 1, 'entryYear': 2025, 'course': 'day',
...
ELECTROINFO_REVIEWS = [{'id': 'y2-end', 'name': '2年次終了時審査', 'when': '2年次終了時', 'source': '2.4.1, 別表3, 別表3の2', 'anyOf': [{'allOf': [{'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjects', 'codes': ['PHY204h', 'MTH301h'], 'note': '別表3: 類共通基礎科目のうち力学・確率統計（1・2年次開講の必修科目、計4単位）'}]}, {'type': 'totalCredits', 'min': 60, 'note': '特例。ただし卒業研究着手までには前項の科目の単位を必ず修得しなければならない'}], 'onFail': {'blockedSubjects': ['ELE502h', 'ELE602h', 'ELE603h'], 'note': '不合格時はELE502h・ELE602h・ELE603hを履修できない'}}, {'id': 'thesis-start', 'name': '卒業研究着手審査', 'when': '3年次終了時', 'source': '2.4.3, 別表4', 'allOf': [{'type': 'review', 'id': 'y2-end'}, {'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'allOf': [{'type': 'subjectsCountMin', 'codes': ['MTH301h', 'PHY204h', 'MTH302h', 'MTH401h', 'ELE301h', 'PHY301h', 'GSE301h', 'GSE401h', 'COM301h', 'COM401h'], 'min': 9}, {'type': 'subjectsCreditMin', 'codes': ['MTH301h', 'PHY204h', 'MTH302h', 'MTH401h', 'ELE301h', 'PHY301h', 'GSE301h', 'GSE401h', 'COM301h', 'COM401h', 'MTH303h', 'MTH304h', 'PHY302h'], 'min': 21}]}, {'type': 'subjects', 'codes': ['ELE502h', 'ELE602h', 'ELE603h'], 'note': '別表4: 類専門科目の指定科目'}, {'type': 'totalCredits', 'min': 104}]}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 1}, {'type': 'totalCredits', 'min': 133}]}]
ELECTROINFO = {
    'schemaVersion': 1, 'entryYear': 2025, 'course': 'day',
...
CONTROL_REVIEWS = [{'id': 'y2-end', 'name': '2年次終了時審査', 'when': '2年次終了時', 'source': '2.4.1, 別表3, 別表3の2', 'anyOf': [{'allOf': [{'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjects', 'codes': ['PHY204i', 'MTH301i'], 'note': '別表3: 類共通基礎科目のうち力学・確率統計（1・2年次開講の必修科目、計4単位）'}]}, {'type': 'totalCredits', 'min': 60, 'note': '特例。ただし卒業研究着手までには前項の科目の単位を必ず修得しなければならない'}], 'onFail': {'blockedSubjects': ['MCE502i', 'MCE601i'], 'note': '不合格時はMCE502i・MCE601iを履修できない'}}, {'id': 'thesis-start', 'name': '卒業研究着手審査', 'when': '3年次終了時', 'source': '2.4.3, 別表4', 'allOf': [{'type': 'review', 'id': 'y2-end'}, {'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'allOf': [{'type': 'allPassed', 'groupId': 'cluster-basic-req'}, {'type': 'groupMin', 'groupId': 'cluster-basic-elecreq', 'min': 4}]}, {'type': 'subjects', 'codes': ['MCE403i', 'MCE502i', 'MCE601i', 'MCE503i', 'MCE602i'], 'note': '別表4: 類専門科目の指定科目'}, {'type': 'totalCredits', 'min': 104}]}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 4}, {'type': 'totalCredits', 'min': 133}]}]
CONTROL = {
    'schemaVersion': 1, 'entryYear': 2025, 'course': 'day',
...
ROBOTICS_REVIEWS = [{'id': 'y2-end', 'name': '2年次終了時審査', 'when': '2年次終了時', 'source': '2.4.1, 別表3, 別表3の2', 'anyOf': [{'allOf': [{'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjects', 'codes': ['PHY204j', 'MTH301j'], 'note': '別表3: 類共通基礎科目のうち力学・確率統計（1・2年次開講の必修科目、計4単位）'}]}, {'type': 'totalCredits', 'min': 60, 'note': '特例。ただし卒業研究着手までには前項の科目の単位を必ず修得しなければならない'}], 'onFail': {'blockedSubjects': ['MCE503j', 'MCE601j'], 'note': '不合格時はMCE503j・MCE601jを履修できない'}}, {'id': 'thesis-start', 'name': '卒業研究着手審査', 'when': '3年次終了時', 'source': '2.4.3, 別表4', 'allOf': [{'type': 'review', 'id': 'y2-end'}, {'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'allOf': [{'type': 'allPassed', 'groupId': 'cluster-basic-req'}, {'type': 'groupMin', 'groupId': 'cluster-basic-elecreq', 'min': 4}]}, {'type': 'subjects', 'codes': ['MCE403j', 'MCE503j', 'MCE601j', 'MCE504j', 'MCE602j'], 'note': '別表4: 類専門科目の指定科目'}, {'type': 'totalCredits', 'min': 104}]}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 5}, {'type': 'totalCredits', 'min': 133}]}]
ROBOTICS = {
    'schemaVersion': 1, 'entryYear': 2025, 'course': 'day',
...
ELECTRO3 = {
    ...
    'reviews': ELECTRO3_REVIEWS,
}

# ---- 光工学プログラム（data/requirements/2025-day-III-optical.json）
OPTICAL_GROUPS = [{'id': 'specialized', 'name': '専門科目', 'label': '専門', 'required': 86, 'children': [{'id': 'math-basic', 'name': '理数基礎科目', 'required': 20, 'children': [{'id': 'math-basic-req', 'name': '必修', 'label': '理数基礎（必修）', 'required': 20, 'kind': 'required', 'subjects': ['MTH101z', 'MTH201z', 'MTH102z', 'MTH202z', 'MTH203z', 'MTH103z', 'MTH204z', 'PHY102z', 'PHY202z', 'CHM102z', 'COM201z']}, {'id': 'math-basic-sel', 'name': '選択', 'label': '理数基礎（選択）', 'required': 0, 'kind': 'elective', 'countAs': 'common', 'note': '修得した単位は共通単位とする', 'subjects': ['PHY103z', 'PHY203z', 'CHM203z']}]}, {'id': 'cluster-basic', 'name': '類共通基礎科目', 'required': 20, 'children': [{'id': 'cluster-basic-req', 'name': '必修', 'label': '類共通基礎（必修）', 'required': 18, 'kind': 'required', 'subjects': ['PHY204n', 'PHY205n', 'MTH301n', 'PHY301n', 'PHY302n', 'PHY401n', 'ELE301n', 'ELE401n']}, {'id': 'cluster-basic-elecreq', 'name': '選択必修', 'label': '類共通基礎（選択必修）', 'required': 2, 'kind': 'elective-required', 'note': '修得した単位は共通単位とする。夜間主コース学生が「分子生物学」の単位を修得した場合は専門基礎科目の選択科目とする', 'subjects': ['MTH302n', 'MTH303n', 'GSE301n', 'COM301n', 'COM401n', 'COM402n', 'BIO401n']}]}, {'id': 'major', 'name': '類専門科目', 'required': 46, 'children': [{'id': 'major-req', 'name': '必修', 'label': '類専門（必修）', 'required': 34, 'kind': 'required', 'subjects': ['ELE402n', 'PHY402n', 'PHO501n', 'PHO601n', 'PHY501n', 'PHY502n', 'ELE501n', 'PHY601n', 'PHO602n', 'PHO603n', 'ELE601n', 'PHO604n', 'LAB701n', 'LAB801n', 'LAB702n', 'LAB802n']}, {'id': 'major-sel', 'name': '選択', 'label': '類専門（選択）', 'required': 12, 'kind': 'elective', 'note': '他プログラムの類専門科目選択も選択として算入可（実験科目を除く。付録C 注1）。このJSONのsubjectsには他プログラム分もあらかじめ展開済み', 'subjects': ['CHM401n', 'CHM402n', 'BIO501n', 'PHY602n', 'PHY603n', 'PHY604n', 'ELE602n', 'PHY605n', 'ELE603n', 'CHM601n', 'FGN101n', 'FGN201n', 'FGN102n', 'FGN202n', 'FGN301n', 'FGN401n', 'MCE508k', 'MCE509k', 'GSE501k', 'MCE607k', 'MCE608k', 'GSE601k', 'MCE609k', 'MCE701k', 'MCE702k', 'FGN101k', 'FGN201k', 'FGN102k', 'FGN202k', 'FGN301k', 'FGN401k', 'CHM401m', 'CHM402m', 'PHY502m', 'PHY503m', 'PHY603m', 'PHY604m', 'PHY605m', 'PHY606m', 'PHO601m', 'PHY504m', 'ELE603m', 'ELE604m', 'ELE605m', 'ELE701m', 'CHM701m', 'FGN101m', 'FGN201m', 'FGN102m', 'FGN202m', 'FGN301m', 'FGN401m', 'CHM401p', 'CHM402p', 'PHY507p', 'PHY607p', 'ELE601p', 'PHY608p', 'PHY609p', 'FGN101p', 'FGN201p', 'FGN102p', 'FGN202p', 'FGN301p', 'FGN401p', 'ELE601r', 'BIO603r', 'CHM701r', 'FGN101r', 'FGN201r', 'FGN102r', 'FGN202r', 'FGN301r', 'FGN401r']}, {'id': 'major-free', 'name': '自由科目', 'label': '自由科目', 'required': 0, 'kind': 'free', 'countsTowardGraduation': False, 'note': '地学・生物学関連科目、UECパスポートプログラム、大学院連携科目など。卒業要件に含まれない', 'subjects': ['GEO201n', 'GEO501n', 'BIO502n', 'UEC302n', 'UEC501n', 'UEC701n', 'COM501n', 'PHOa01n', 'PHOa02n', 'PHYa01n', 'PHYa02n', 'ELEa01n', 'ELEa02n', 'CHMa01n', 'PHYb01n', 'PHYb02n', 'LAB501n']}, {'id': 'major-intl', 'name': '国際科目', 'label': '国際科目', 'required': 0, 'kind': 'international', 'note': '単位の扱いは年度ごとの科目一覧表による', 'subjects': ['INT401n', 'INT001n', 'INT002n', 'INT003n']}]}]}]
OPTICAL_REVIEWS = [{'id': 'y2-end', 'name': '2年次終了時審査', 'when': '2年次終了時', 'source': '2.4.1, 別表3, 別表3の2', 'anyOf': [{'allOf': [{'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjects', 'codes': ['PHY204n', 'PHY205n'], 'note': '別表3: 類共通基礎科目のうち力学・力学演習（1年次開講の必修科目2科目、計3単位）'}]}, {'type': 'totalCredits', 'min': 60, 'note': '特例。ただし卒業研究着手までには前項の科目の単位を必ず修得しなければならない'}], 'onFail': {'blockedSubjects': ['PHO501n', 'PHO601n'], 'note': '不合格時はPHO501n・PHO601nを履修できない'}}, {'id': 'thesis-start', 'name': '卒業研究着手審査', 'when': '3年次終了時', 'source': '2.4.3, 別表4', 'allOf': [{'type': 'review', 'id': 'y2-end'}, {'type': 'groupMin', 'groupId': 'lang-basic-1', 'min': 4}, {'type': 'groupMin', 'groupId': 'lang-basic-2', 'min': 2}, {'type': 'allPassed', 'groupId': 'health-req'}, {'type': 'allPassed', 'groupId': 'intro'}, {'type': 'subjects', 'codes': ['UEC301z']}, {'type': 'allPassed', 'groupId': 'math-basic-req'}, {'type': 'subjectsCreditMin', 'codes': ['PHY204n', 'PHY205n', 'MTH301n', 'PHY301n', 'PHY302n', 'PHY401n', 'ELE301n', 'ELE401n', 'ELE402n', 'PHY402n'], 'min': 16, 'note': '別表4: 2年次までの類共通基礎科目及び類専門科目の必修科目のうち規定単位数以上'}, {'type': 'subjects', 'codes': ['ELE402n', 'PHO501n', 'PHO601n'], 'note': '別表4: 類専門科目の指定科目'}, {'type': 'totalCredits', 'min': 104}]}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 4}, {'type': 'totalCredits', 'min': 133}]}]
OPTICAL = {
    'schemaVersion': 1, 'entryYear': 2025, 'course': 'day',
...
EVENING_REVIEWS = [{'id': 'seminar-eligibility', 'name': '輪講履修条件', 'when': '3年次前学期（5学期）終了まで', 'source': '2.4.2', 'allOf': [{'type': 'totalCredits', 'min': 71}]}, {'id': 'thesis-start', 'name': '卒業研究着手審査（卒業研究を選択履修する場合）', 'when': '3年次終了時', 'source': '2.4.3, 別表4 4.2（夜間主コース）', 'allOf': [{'type': 'groupMin', 'groupId': 'intro', 'min': 4}, {'type': 'subjects', 'codes': ['UEC301s']}, {'type': 'groupMin', 'groupId': 'math-basic-req', 'min': 12}, {'type': 'groupMin', 'groupId': 'prof-basic-req', 'min': 19}, {'type': 'totalCredits', 'min': 90}], 'caveat': 'この審査基準を満たした上、先端工学基礎課程長（会議）の了承を必要とする'}, {'id': 'graduation', 'name': '卒業審査', 'when': '4年次終了時', 'source': '2.4.4, 別表2', 'allOf': [{'type': 'allGroups'}, {'type': 'commonCredits', 'min': 6}, {'type': 'totalCredits', 'min': 124}]}]
EVENING = {
